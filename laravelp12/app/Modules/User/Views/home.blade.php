                       ...
                       @foreach ($annonce as $ann)
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="sale-item">
                                ...
                                <div class="item-info">
                                    <h3><a href="11_Single_Properties_Standart.html" title="">{{$ann->titre}}</a></h3>
                                    <span>{{$ann->etat}}</span>
                       ...
                       @foreach($user as $us)
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="team">
                                ...
                                <div class="team-info">
                                    <h3><a href="agent-profile.html" title="">{{$us->name}}</a></h3>
                                    <span>{{$us->phone}}</span>
                                    <p>{{$us->email}}</p>
                                    <a href="{{route('afficherProfil',$us->id)}}" title="" class="lnk-default">View Profile</a>
                                </div><!--team-info end-->
                            </div><!--team end-->
                        </div>
                        @endforeach
