...
<form action="https://secure.avis.ma/resultats-vehicule" method="get" class="car-rental-search js-car-search" id="getAQuote" autocomplete="off">
  ...
  <div id="car-search-instructions" class="is-visually-hidden" aria-live="polite" >
    ...
    <p>
      Indiquez l’agence où vous voulez prendre votre véhicule à l’aide du formulaire de recherche ci-dessous. 
    </p>
    <p>
       Veuillez indiquer ensuite vos dates de départ et de retour. 
    </p>
    <p>
       Vous pouvez également indiquer votre numéro AWD (Remise internationale Avis). Vous pouvez réserver un véhicule utilitaire ou un scooter si ceux-ci sont disponibles dans votre agence.
    </p>
  ...
  <ul class="skiplinks" id="car-search-skip-links">
    <li>
      <a href="#hire-search">
        Passer directement à la recherche de véhicule
      </a>
    </li>
    <li>
      <a href="#pick-up-date-button">
       Passer directement au bouton de sélection de la date de départ 
      </a>
    </li>
    <li>
      <a href="#pick-up-time-button">
       Passer directement au bouton de sélection de l’heure de départ 
      </a>
    </li>
    <li>
      <a href="#drop-off-date-button">
      Passer directement au bouton de sélection de la date de retour 
      </a>
    </li>
    <li>
      <a href="#drop-off-time-button">
       Passer directement au bouton de sélection de l’heure de retour 
      </a>
    </li>
    <li>
      <a href="#form-end">
        Passer directement à la sélection d’une autre agence
      </a>
    </li>
    <li>
      <a href="#car-search-submission">
      Passer directement à l’envoi du formulaire
      </a>
    </li>
  </ul>
...
<span class="hire-container">
  ...
  <label for="hire-search" class="is-visually-hidden">
    ...
    <input id="hire-search" data-station-select="" data-disabledspan ="false" name="hire-search" class="js-lookahead required" placeholder="Commencez votre voyage à partir de ... " maxlength="250" autocomplete="off" value=""/>
    ...
    <span class="date-field">
      ...
      <a href="#set-pick-up-date" class="set-date-time-button set-from-date" id="pick-up-date-button">
        <span class="is-visually-hidden">
          La date de départ choisie est le
        </span>
        <span class="day">
          &nbsp;
        </span>
...
<span class="go-same-location"></span>
  ...
  <section id="set-pick-up-date"  tabindex="-1" class="date-from calendar-flyout-container" aria-atomic="true" aria-live="polite">
    ...
    <a class="skiplink" href="#end-form">
      ignorer le calendrier de départ
    </a>
  ...
  <section id="set-from-time" tabindex="-1" class="set-brand-container clearfix time-from time-flyout-container no-table"  aria-atomic="true" aria-live="polite">
    <div class="opening-hours-box">
      <div class="opening-hours-inner">
        <div class="opening-hours">
          <input type="hidden" name="openingHourText" id="openingHourText" value="Heures d’ouverture">
        </div>
      </div>
    </div>
    ...
    <div id="time-from-container" class="time-select-container">
      <div class="inner">
        ...
        <a class="skiplink" href="#end-form">
           ignorer le sélecteur d’heure de départ
        </a>
...
<section id="set-to-time" tabindex="-1" class="set-brand-container clearfix time-to time-flyout-container no-table" aria-atomic="true" aria-live="polite">
    ...
    <div id="time-to-container" class="time-select-container">
      <div class="inner">
        ...
        <a class="skiplink" href="#end-form">
          ignorer le sélecteur d’heure de retour
        </a>
    ...
    <div class="car-rental-search-options">
       <span class="option-item return-option option-item-checkbox">
        <label for="returnToDifferentLocation">
          ...
          <span class="checkbox-title">Retour à une agence différente</span>
         </label>
       </span>
         <!-- YDS QB -->
          ...
          <span class="qb-yds-text clearfix">
            ...
            <span class="qb-yds-q">?
              <span class="qb-yds-qtext">
                Si vous avez moins de 30 ans et plus de 70 ans, merci de renseigner votre date de naissance afin d’accéder aux véhicules correspondant au mieux à votre profil.
              </span>
            </span>
          </span>
          ...
          <span class="qb-yds-checkbox">
            <label for="yds-applicable">
              ...
              <span class="checkbox-title">
                Conducteur âgé entre 30 et 70 ans
              </span>
            </label>
...
<div id="mapOverlay" class="<%= setOverlayClass(error) %>">
                            ...
                            <% if ((is24hrs(dataItem.is24hrs) == true) || (isDelColAvailable(dataItem.IsDeliveryAndCollectionAvailable) == true)){%>
                              <div class="delivery-collection-24hr">
                                ...
                                <% if (isDelColAvailable(dataItem.IsDeliveryAndCollectionAvailable) == true){%>
                                  <p>Livraison et reprise disponibles à cette agence</p>
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="is-visually-hidden">Heures d’ouverture</th>
    ...
    <% if (is24hrs == true) { %>
        <p class="opening-hours-is24hrs">
            Vous pouvez rapporter votre véhicule à n’importe quelle heure, en utilisant notre boîte de retour sécurisée. En revanche, vous serez responsable de tout dommage subi par le véhicule jusqu'à la réouverture de l'agence. Pensez simplement à nous prévenir à l’avance.
        </p>
    <% } %>
    <% if (isDelandColAvailable == true) { %>
        <p class="opening-hours-is24hrs">
            Livraison et reprise disponibles à cette agence
        </p>
    <% } %>
</script>
...
<div class="addr_cont_div">
  ...
  <h2 class="naapTitle1">Coordonnées</h2>
    <span class="changeFontSize">
       34 Rue Pierre Parent,
       Casablanca,
       20000.
    &nbsp; Tél : <a href="tel:+212522 31 24 24">+212522 31 24 24</a><br/>
    </span>
...
<div class="content-51b-image l-col-50 feature-2-2">
        ...
        src="" alt="Avis location de voiture à casablanca"/>
